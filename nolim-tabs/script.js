(function () {
  ...
  t_ready(function () {
            ...
            if (!window.sliderBlocksList.includes(block)) {
              ...
              if (n < e - 500)
                return (
                  ...
                  "animatednumber" ===
                    t_animate__getAttrByResBase(t, "style") &&
    ...
    if (
      window.nlm061obj &&
      window.nlm061obj.blocksHideOnLoadPage.includes("#" + firstBlock.id)
    ) {
    } else {
        ...
        if (el.hasAttribute("data-animate-style")) {
          if (el.hasAttribute("data-animate-delay")) {
            el.style.transitionDelay =
              el.getAttribute("data-animate-delay") + "s";
          }
          if (el.hasAttribute("data-animate-duration")) {
    ...
    function setActiveTab() {
      ...
      const activeTab = allTabs.find((tab) =>
        tab.querySelector(`[href="${somebuttons}${blocksID + 1}"]`)
      );
      if (activeTab) {
    ...
    function scrollToTabs() {
        $('html, body').animate({
            scrollTop: $("#rec633468546").offset().top
        });
    }
      ...
      function (e) {
        for (
          ...
          if (
            ...
            console.log(href);
            const num = href.split(
              href.includes("=") ? `${somebuttons}=` : somebuttons
            )[1];
            console.log(num);
            blocksID = num - 1;
            showAnotherTab();
